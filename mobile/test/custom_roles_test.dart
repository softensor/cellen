...
void main() {
  ...
  testWidgets(
      'owner adds, renames and disables a role without dropping settings',
      (tester) async {
    ...
    await tester.pumpWidget(ProviderScope(
      ...
      child: const MaterialApp(
          home: SchoolConfigScreen(schoolId: 'school', schoolName: 'School')),
    ));
    ...
    await tester.enterText(
        find.byType(TextFormField), 'Assistente de Secretaria');
    await tester.tap(find.text('Guardar função'));
    await tester.pumpAndSettle();
    final tile = find.ancestor(
        of: find.text('Assistente de Secretaria'),
